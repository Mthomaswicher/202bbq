      ...
      <div className="container">
        ...
        <div className="about-grid">
          ...
          <div className="about-text prose">
            ...
            <p>202BBQ started with a backyard, a used smoker and an obsession with getting it right. Named 202 because this is a Washington thing. {SITE.licence ? `Licensed by ${SITE.licence}.` : "It's a fully licensed DC food business."}</p>
            {battle && <p>In {battle.start.slice(0, 4)} we took part in the {battle.title} on Pennsylvania Avenue.</p>}
            <p>You'll find me at popups and markets around the city — dates go up on Instagram first.</p>
