  ...
  return (
    <section className="hero" aria-label="Welcome to 202BBQ">
      ...
      <div className="container hero-inner">
        ...
        {/* Right: explosion photo cluster */}
        <div className="hero-explosion" aria-hidden="true">
          <div className="explosion-photo explosion-photo--1">
            <img src={`${BASE}photos/hero-pork.jpg`} alt="" loading="eager" />
          </div>
          <div className="explosion-photo explosion-photo--2">
            <img src={`${BASE}photos/hero-brisket.jpg`} alt="" loading="eager" />
          </div>
          <div className="explosion-photo explosion-photo--3">
            <img src={`${BASE}photos/hero-chicken.jpg`} alt="" loading="eager" />
          </div>
          <div className="explosion-photo explosion-photo--4">
            <img src={`${BASE}photos/hero-ribs.jpg`} alt="" loading="eager" />
          </div>
        </div>
